...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5339184,
    DYNAMIC_BASE = 5339184,
    DYNAMICTOP_PTR = 96272;
...
// STATICTOP = STATIC_BASE + 95280;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_synfilt_cpp() } });
...
Module["asm"] = asm;
var __GLOBAL__sub_I_synfilt_cpp = Module["__GLOBAL__sub_I_synfilt_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_synfilt_cpp"].apply(null, arguments)
};
