    ...
    switch (gr_info->block_mode) {
        case SHORT_BLOCK_MODE:
            do_short_quant(
                ...
                quant,
                dequant,
                scale_fac->scalefac_short,
                gr_info->subblock_gain,
                0,
                sfbData->max_sfb_short,
                sfbData->sfbWidthCumShort,
                gr_info->zero_part_start,
                gain_shift,
                dbS);
            break;
